...
public class RentToLegalTableModel extends AbstractTableModel {
    SimpleDateFormat sdf;
    private List<RentToLegal> rentData = null;
    ...
    public void addRow(RentToLegal rent) {
