...
public class LegalClient extends Client implements Manipulation {
    ...
    public String dismount() {
        String legalDismount = "";
        legalDismount += id + ";";
        legalDismount += name + ";";
        legalDismount += socialName + ";";
        legalDismount += adress.getPlace() + ";";
        legalDismount += adress.getNumber() + ";";
        legalDismount += adress.getNeighborhood() + ";";
        legalDismount += contact.getTelephone() + ";";
        legalDismount += contact.getCellPhone() + ";";
        legalDismount += contact.getEmail() + ";";
        legalDismount += socialId + ";";
        return legalDismount;
    }
}
